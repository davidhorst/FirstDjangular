app.controller('mainController', ['$scope', '$location', '$auth', 'usersFactory', '$localStorage', 'jwtHelper', function($scope, $location, $auth, usersFactory, $localStorage, jwtHelper) {
